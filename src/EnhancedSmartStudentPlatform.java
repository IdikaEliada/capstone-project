// Enhanced Smart Student Platform - Modern UI Implementation
// File: EnhancedSmartStudentPlatform.java
...
class StudentDataManager {
    ...
    private void initializeSampleData() {
        ...
        // Sample students
        Student s1 = new Student("John Doe", "STU001", "200 Level", "Computer Science");
        s1.addResult(courses.get(0), 85.0);
        s1.addResult(courses.get(1), 92.0);
        students.add(s1);
        
        Student s2 = new Student("Jane Smith", "STU002", "300 Level", "Software Engineering");
...
public class EnhancedSmartStudentPlatform extends JFrame {
    ...
    private void viewStudentDetails() {
        ...
        addInfoRow(infoPanel, gbc, "Student ID:", student.getId(), 0);
