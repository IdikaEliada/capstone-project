...
public class EnhancedSmartStudentPlatform extends JFrame {
    ...
    // Colors
    private final Color PRIMARY_COLOR = new Color(30, 64, 175); 
    private final Color SECONDARY_COLOR = new Color(37, 99, 235);
    private final Color DANGER_COLOR = new Color(231, 76, 60);
    private final Color WARNING_COLOR = new Color(96, 165, 250);
    ...
    private void initializeModernGUI() {
        setTitle("Clairify Smart Student Platform");
    ...
    private void createModernHeader() {
        ...
        // Title
        JLabel titleLabel = new JLabel("Cruciqe Smart Student Platform", SwingConstants.LEFT);
        titleLabel.setFont(new Font("Segoe UI", Font.BOLD, 28));
        titleLabel.setForeground(Color.WHITE);
        titleLabel.setBorder(BorderFactory.createEmptyBorder(20, 0, 20, 0));
        
        // Subtitle
        JLabel subtitleLabel = new JLabel("Comprehensive Student Management System built by group 8 CYB", SwingConstants.LEFT);
